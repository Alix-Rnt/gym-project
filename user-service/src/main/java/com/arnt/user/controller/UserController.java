...
public class UserController {
    ...
    */
    ...
    public ResponseEntity<Void> validateToken() {
        // Simulation temporaire : On dit "OK" à Nginx à chaque fois
        // Cela te permet de tester l'accès complet à Booking, Catalog, etc.
        System.out.println("--> Nginx a demandé une validation : Accès accordé (200 OK) ! ");
